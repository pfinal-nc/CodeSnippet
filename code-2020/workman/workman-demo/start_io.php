...
$sender_io->on('workerStart', function () {
    // 监听一个http端口
    $inner_http_worker = new \Workerman\Worker('http://0.0.0.0:2121');
    // 当http客户端发来数据时触发
    $inner_http_worker->onMessage = function (\Workerman\Connection\TcpConnection $http_connection, \Workerman\Protocols\Http\Request $request) {
